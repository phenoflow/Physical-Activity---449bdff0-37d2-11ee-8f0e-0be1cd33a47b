...
codes = [{"code":"1384.00","system":"readv2"},{"code":"138I.00","system":"readv2"},{"code":"138J.00","system":"readv2"},{"code":"138K.00","system":"readv2"},{"code":"138L.00","system":"readv2"},{"code":"138M.00","system":"readv2"},{"code":"138V.00","system":"readv2"}];
REQUIRED_CODES = 1;
